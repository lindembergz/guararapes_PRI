...
namespace LukeSkywalker.Models
{
    public class Starship
    {
        ...
        public List<People> people { get; set; }/// An array of People URL Resources that this starship has been piloted by.
        public List<Film> films { get; set; } // An array of Film URL Resources that this starship has appeared in
