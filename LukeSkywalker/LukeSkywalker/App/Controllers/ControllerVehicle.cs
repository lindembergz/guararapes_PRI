...
namespace LukeSkywalker.App.Controllers
{
    ...
    public class ControllerVehicle : ControllerBase
    {
        private readonly IServiceVehicle service;

        public ControllerVehicle(IServiceVehicle _service)
        {
        ...
        public IActionResult Get(int id)
        {
            try
            {
                Vehicles entityActual = service.GetById(id);
        ...
        public IActionResult Create([FromBody] Vehicles entity)
        {
            try
            {
        ...
        [EnableCors("AnotherPolicy")]
        [HttpPut]
        public IActionResult Modify([FromBody] Vehicles entity)
        {
            try
            {
                if (ModelState.IsValid)
