...
{
    [Route("api/v1/StarShip")]
    [ApiController]

    public class ControllerStarShip : ControllerBase
    {
        private readonly IServiceStarship service;

        public ControllerStarShip(IServiceStarship _service)
        {
