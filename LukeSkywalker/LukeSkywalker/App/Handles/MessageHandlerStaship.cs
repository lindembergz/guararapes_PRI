...
{
    public class MessageHandlerStarShip : IHostedService
    {
        private readonly ILogger _logger;
        public MessageHandlerStarShip(ILogger<MessageHandlerStarShip> logger)
        {
            _logger = logger;
        }
